...
class TokenGenerator:
    ...
    def update_config(self) -> None:
        ...
        tokens = self.create_jwt(ORG_SECRET_KEY, ORG_DID, [node["did"] for node in NODE_CONFIG.values()], 3600)
...
def upload_gamedev(email: str, company_name: str, password: str, website: str, description: str, wallet_address: str, private_key: str) -> bool:
    """Create and store GameDev data across nodes."""
    try:
        # Generate unique GameDev ID
